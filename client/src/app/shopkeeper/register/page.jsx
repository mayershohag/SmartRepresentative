...
export default function ShopkeeperRegister() {
     ...
     const validateStep = (step) => {
          ...
          if (step === 1) {
               ...
               if (
                    ...
                    errors.phone = "Valid Bangladeshi phone number required.";
               }
          }
          ...
          if (step === 3) {
               ...
               if (!formData.shopAddress.trim()) {
                    errors.shopAddress = "Detailed shop address is required.";
               }
          }
     ...
     const handleSubmit = async (e) => {
          ...
          try {
               ...
               const response = await Register(credentials, "shopkeeper");
               ...
               <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
                    <div className="max-w-md w-full bg-white rounded-4xl shadow-2xl p-8 text-center border border-gray-100 animate-in fade-in zoom-in duration-500">
                         ...
                         <p className="text-gray-500 mb-8">
                              Your shopkeeper account has been created
